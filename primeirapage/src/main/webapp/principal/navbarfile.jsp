...
<nav class="navbar header-navbar pcoded-header" style="top: 0;">
              <div class="navbar-wrapper">
                  <div class="navbar-logo">
                      <a class="mobile-menu waves-effect waves-light" id="mobile-collapse" href="<%= request.getContextPath() %>/principal/principal.jsp">
                          <i class="ti-menu"></i>
                      </a>
                  ...
                  <div class="navbar-container container-fluid">
                      ...
                      <ul class="nav-right">
                          ...
                          <li class="user-profile header-notification">
                              <a href="#!" class="waves-effect waves-light">
                                  <img src="${fotouser }" class="img-radius" style="height: 40px" alt="User-Profile-Image">
